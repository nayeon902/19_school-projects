...
<script>
   setTimeout(function() { 
    document.getElementById("time1").innerHTML= '스타벅스 김해 내동점'

}, 2000);
  setTimeout(function() { 
    document.getElementById("time2").innerHTML= 'CU김해 내동점'

}, 2000);
  setTimeout(function() { 
    document.getElementById("time3").innerHTML= '아웃백 김해점'

}, 2000);
  setTimeout(function() { 
    document.getElementById("time4").innerHTML= '르하임 스터디 카페 내동점'
