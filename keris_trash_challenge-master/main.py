...
if __name__ == '__main__':
    ...
    args.add_argument("--step_size", type=int, default=16)
    ...
    optimizer = AdamW(
        ...
        lr=config.base_lr, weight_decay=1e-2)
    ...
    if config.mode == 'train':
        ...
        for epoch in range(config.num_epochs):
            ...
            nsml.report(step=epoch, train_loss=loss_average, learning_rate=optimizer.param_groups[0]['lr'])
